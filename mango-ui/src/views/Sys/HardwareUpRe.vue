...
                {prop:"name", label:"名称", minWidth:120},
	...
	methods: {
		...
		findPage: function (data) {
			...
			this.pageRequest.params = {use:this.filters.use==''?'0':this.filters.use, protocol:this.filters.protocol==''?'0':this.filters.protocol,name:this.filters.name==''?'0':this.filters.name,falg:'硬件'}
